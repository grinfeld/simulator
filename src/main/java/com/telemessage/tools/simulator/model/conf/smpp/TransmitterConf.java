...
public class TransmitterConf extends SMPPConnectionTypeConf {
    public TransmitterConf() {}

    @lombok.Builder(builderClassName = "Builder", toBuilder = true)
    protected TransmitterConf(BindType bindType, String host, int port, long timeout, byte dataCoding, String systemId, String password, String systemType, String encoding, BindOption bindOption, ConcatenationType concatenation, int threads, byte srcTON, byte srcNPI, byte dstTON, byte dstNPI, byte clbTON, byte clbNPI) {
